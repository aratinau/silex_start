...
class ApiController {
    ...
    // Nous déplaçons dans ce fichier les contrôleurs de notre API. Au passage, l'ajout de la méthode privée buildArticle Array permet d'éliminer la duplication de code entre les contrôleurs.
}
